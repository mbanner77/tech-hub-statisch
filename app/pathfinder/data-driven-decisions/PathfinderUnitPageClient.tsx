...
export default function PathfinderUnitPageClient() {
  ...
  useEffect(() => {
    const currentUnit = pathfinderUnits.find((u) => u.id === "data-driven-decisions")
    if (currentUnit) {
      setUnit(currentUnit)
    } else {
  ...
  const nextUnit =
    pathfinderUnits[(pathfinderUnits.findIndex((u) => u.id === "data-driven-decisions") + 1) % pathfinderUnits.length]
  const prevUnit =
    pathfinderUnits[
      (pathfinderUnits.findIndex((u) => u.id === "data-driven-decisions") - 1 + pathfinderUnits.length) %
        pathfinderUnits.length
    ]
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="w-full sm:w-auto">
                <Select value="data-driven-decisions" onValueChange={handleUnitChange}>
